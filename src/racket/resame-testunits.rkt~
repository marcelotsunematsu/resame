...
(define (teste-infra)
  (test-suite 
   ...
   (test-case
    "Ler jogo"
   (check-equal? (ler-jogo "/home/fabricio/resame-racket-pro/testes/alguns/com-solucao/3-3-3")
              '(("1" "1" "1") ("3" "3" "2") ("2" "1" "2"))))
   ...
   (test-case
    "arquivo->jogo"
    (check-equal? (arquivo->jogo same "/home/fabricio/resame-racket-pro/testes/alguns/com-solucao/3-3-3") 
                  '((1 1 1) (3 3 2) (2 1 2))))
   (test-case
    "grupo-flood"
    (check-equal? (grupo-flood same '() p12) group12))))
   )
  )
